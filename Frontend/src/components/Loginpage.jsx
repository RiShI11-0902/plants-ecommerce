                            ...
                            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                ...
                                <form onSubmit={handleForm} className="space-y-4 md:space-y-6" action="#">
                                    ...
                                    <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                        {register ? "Have an account " : "Don't have an account yet? "}   <span onClick={() => setRegister(!register)} className="font-medium text-primary-600 hover:underline dark:text-primary-500 cursor-pointer"> {register ? "Sign in" : "Register "} </span>
                                    </p>
                                </form>
                            </div>
                        </div>
